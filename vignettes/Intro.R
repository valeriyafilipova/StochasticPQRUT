...
# 
xM=sapply(1:length(b2),function(x) max(as.numeric(PT_ev[[x]][[1]])))
#then take the medium of all values
  #in this case the model performance is poor
fn1=function(par,...){
qsim=PQRUT(int1=b1[11,2:4],tm1 = PT_ev[[11]],kd=3,durt =48,param.station =c(0.1138291,0.028429,19.85680),Area1 = 157, snpSpt=0.3,ttsnow=-3,Tmax=0.5,Tmin=0.5 )
KGE1=-KGE(qsim[[1]],q_ev[[11]][,2])
